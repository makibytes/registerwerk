  ...
  template: `
    <div class="page">
      <div class="card">
        ...
        <p class="intro">Set your password to activate your customer portal access.</p>
        ...
        @if (loading) {
          ...
          <div class="state-box success-box">
            ...
            <span>Your account is ready. Redirecting to sign-in…</span>
          </div>
        } @else {
        ...
        <p class="footer-copy">Already set up? <a routerLink="/login">Go to sign in</a></p>
      </div>
    </div>
  `,
  styles: [`
    .page {
      ...
      background:
        ...
        radial-gradient(circle at bottom right, rgba(13, 148, 136, 0.18), transparent 26%),
        #0f172a;
    }
