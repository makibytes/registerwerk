...
@Component({
  ...
  styles: [`
    ...
    .subtitle { font-size: 12px; color: var(--rw-text-muted); margin: 0 0 20px; font-family: monospace; word-break: break-all; }
  ...
  template: `
    ...
    <mat-dialog-content style="padding: 0 24px 8px">
      <mat-form-field appearance="outline">
        ...
        <input matInput [(ngModel)]="name" placeholder="e.g. Counterparty wallet" maxlength="200" />
      </mat-form-field>
      <mat-form-field appearance="outline">
      ...
      <mat-form-field appearance="outline">
        ...
        <textarea matInput [(ngModel)]="notes" rows="2" maxlength="500"></textarea>
      </mat-form-field>
    </mat-dialog-content>
