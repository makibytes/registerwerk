...
public record WalletExportedKeystoreEvent(UUID walletId, UUID actorId, String actorRole) implements AuditableEvent {
    public String eventType()   { return "WALLET_EXPORTED_KEYSTORE"; }
