package de.makibytes.registerwerk.application.chain;
...
public class ChainConfigService {
    ...
    public ChainConfig create(ChainConfig config) {
        ...
        auditEventPublisher.publish(
                "CHAIN_ADDED", "ChainConfig", saved.getId(), null, null,
                Map.of("identifier", saved.getIdentifier(), "chainType", saved.getChainType().name()));
    ...
    public ChainConfig update(UUID id, ChainConfig patch) {
        ...
        auditEventPublisher.publish(
                "CHAIN_UPDATED", "ChainConfig", saved.getId(), null, null,
                Map.of("identifier", saved.getIdentifier()));
