...
public class CantonTokenService {
    ...
    public CompletableFuture<String> createInstrument(
        ...
        return CompletableFuture.supplyAsync(() -> {
            ...
            auditEventPublisher.publish("CANTON_INSTRUMENT_CREATED", "Asset", assetId, null,
                    null, Map.of("network", network.name(), "issuer", issuerPartyId, "updateId", updateId));
            return updateId;
        });
    }
    ...
    public CompletableFuture<String> issue(UUID deploymentId, String recipientPartyId, BigDecimal amount) {
        return CompletableFuture.supplyAsync(() -> {
            ...
            auditEventPublisher.publish("CANTON_TOKENS_ISSUED", "AssetDeployment", deploymentId, null,
                    null, Map.of("recipient", recipientPartyId, "amount", amount.toPlainString()));
            return updateId;
        });
    }
    ...
    public CompletableFuture<String> transfer(
        ...
        return CompletableFuture.supplyAsync(() -> {
            ...
            auditEventPublisher.publish("CANTON_TRANSFER", "AssetDeployment", deploymentId, null,
                    null, Map.of("from", fromParty, "to", toParty, "amount", amount.toPlainString()));
            return updateId;
        });
    }
    ...
    public CompletableFuture<String> forceTransfer(
        ...
        return CompletableFuture.supplyAsync(() -> {
            ...
            auditEventPublisher.publish("CANTON_FORCE_TRANSFER", "AssetDeployment", deploymentId, null,
                    null, Map.of("to", toParty, "amount", amount.toPlainString(), "reason", reason));
            return updateId;
        });
    }
    ...
    public CompletableFuture<String> freezeHolding(UUID deploymentId, String holdingContractId) {
        return CompletableFuture.supplyAsync(() -> {
            ...
            auditEventPublisher.publish("CANTON_HOLDING_LOCKED", "AssetDeployment", deploymentId, null,
                    null, Map.of("holdingCid", holdingContractId));
            return updateId;
        });
    }
    ...
    public CompletableFuture<String> unfreezeHolding(UUID deploymentId, String holdingContractId) {
        return CompletableFuture.supplyAsync(() -> {
            ...
            auditEventPublisher.publish("CANTON_HOLDING_UNLOCKED", "AssetDeployment", deploymentId, null,
                    null, Map.of("holdingCid", holdingContractId));
            return updateId;
        });
    }
    ...
    public CompletableFuture<String> burn(UUID deploymentId, String holdingContractId, BigDecimal amount) {
        return CompletableFuture.supplyAsync(() -> {
            ...
            auditEventPublisher.publish("CANTON_BURN", "AssetDeployment", deploymentId, null,
                    null, Map.of("holdingCid", holdingContractId, "amount", amount.toPlainString()));
            return updateId;
        });
    }
    ...
    public CompletableFuture<String> pauseInstrument(UUID deploymentId) {
        return CompletableFuture.supplyAsync(() -> {
            ...
            auditEventPublisher.publish("CANTON_INSTRUMENT_PAUSED", "AssetDeployment", deploymentId, null,
                    null, Map.of());
            return updateId;
        });
    }
    ...
    public CompletableFuture<String> unpauseInstrument(UUID deploymentId) {
        return CompletableFuture.supplyAsync(() -> {
            ...
            auditEventPublisher.publish("CANTON_INSTRUMENT_RESUMED", "AssetDeployment", deploymentId, null,
                    null, Map.of());
            return updateId;
        });
    }
