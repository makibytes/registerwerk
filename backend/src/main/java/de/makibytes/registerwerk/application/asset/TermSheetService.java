...
import de.makibytes.registerwerk.infrastructure.persistence.jpa.AssetDocumentContentRepository;
...
public class TermSheetService {
    ...
    private void auditDocument(String eventType, AssetDocument doc, UUID actorId) {
        auditEventPublisher.publish(
            eventType, "AssetDocument", doc.getId(), actorId, null,
            Map.of("assetId", doc.getAssetId(), "documentType", doc.getDocumentType(),
