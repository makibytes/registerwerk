...
public class Erc3643LifecycleService {
    ...
    public void addComplianceModule(
        ...
        auditPublisher.publish(
            "COMPLIANCE_MODULE_ADDED",
            "Erc3643ComplianceModule",
            saved.getId(),
            null,
            "REGISTRY_ADMIN",
            Map.of("suiteId", suiteId.toString(), "moduleType", moduleType, "moduleAddress", moduleAddress));
    }
    ...
    public void removeComplianceModule(UUID suiteId, UUID moduleId) {
        ...
        auditPublisher.publish(
            "COMPLIANCE_MODULE_REMOVED",
            "Erc3643ComplianceModule",
            moduleId,
            null,
            "REGISTRY_ADMIN",
            Map.of("suiteId", suiteId.toString(), "moduleAddress", module.getModuleAddress()));
    }
    ...
    public void addTrustedIssuer(UUID suiteId, String issuerAddress, List<Long> claimTopics, UUID legalEntityId) {
        ...
        auditPublisher.publish(
            ...
            "Erc3643TrustedIssuer",
            saved.getId(),
            null,
            "REGISTRY_ADMIN",
            Map.of("suiteId", suiteId.toString(), "issuerAddress", issuerAddress));
    }
    ...
    public void removeTrustedIssuer(UUID suiteId, UUID issuerId) {
        ...
        auditPublisher.publish(
            ...
            null,
            "REGISTRY_ADMIN",
            Map.of("suiteId", suiteId.toString(), "issuerAddress", issuer.getIssuerAddress()));
    }
    ...
    public void addRequiredClaimTopic(UUID suiteId, long topic, String label) {
        ...
        auditPublisher.publish(
            ...
            null,
            "REGISTRY_ADMIN",
            Map.of("suiteId", suiteId.toString(), "topic", topic, "label", label));
    }
