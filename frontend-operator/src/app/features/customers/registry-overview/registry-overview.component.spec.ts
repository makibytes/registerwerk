...
describe('RegistryOverviewComponent', () => {
  let service: jasmine.SpyObj<RegistryOverviewService>;

  beforeEach(() => {
    service = jasmine.createSpyObj<RegistryOverviewService>('RegistryOverviewService', ['getOverview']);
  ...
  it('expands the graph for dense lanes and keeps SVG lines on the node centres', () => {
    service.getOverview.and.returnValue(of(overview(7)));
  ...
  it('keeps relationship neighbours visible when an entity is selected', () => {
    service.getOverview.and.returnValue(of(overview(2)));
    const fixture = TestBed.createComponent(RegistryOverviewComponent);
    fixture.detectChanges();
    ...
    expect(component.isUnrelated('investor-1')).toBeFalse();
    expect(component.isUnrelated('issuer-1')).toBeTrue();
  });
  ...
  it('renders an explicit empty graph state when no relationships match', () => {
    service.getOverview.and.returnValue(of(overview(1)));
    const fixture = TestBed.createComponent(RegistryOverviewComponent);
    fixture.detectChanges();
  ...
  it('shows a recoverable error state instead of an empty graph when loading fails', () => {
    service.getOverview.and.returnValue(throwError(() => new Error('network unavailable')));
    const fixture = TestBed.createComponent(RegistryOverviewComponent);
    fixture.detectChanges();
