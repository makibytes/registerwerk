...
assert.equal(links[0].href, 'http://nibbler.local:8003/customer/dashboard/');
assert.equal(links[1].href, 'http://nibbler.local:8003/de/customer/dashboard/');
assert.equal(links[2].href, 'http://nibbler.local:8003/fr/customer/dashboard/?tab=kyc#documents');
