...
This starts:
- **Prometheus** at `http://localhost:49090`
- **Grafana** at `http://localhost:43000` (login: `admin` / `$GRAFANA_ADMIN_PASSWORD`, see `.env.example`)
- **Alertmanager** at `http://localhost:49093`
