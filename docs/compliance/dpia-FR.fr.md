---
title: DPIA — France
description: Analyse d'impact relative à la protection des données (DPIA) en projet pour la juridiction FR_AMF — nécessite la validation du DPO et d'un conseiller juridique avant la mise en production.
---
...
# Analyse d'impact relative à la protection des données — Juridiction FR_AMF

**Système :** Registerwerk  
**Juridiction :** FR — AMF / ACPR / Code monétaire et financier / Loi PACTE  
**DPO :** [À remplir]  
**Date :** 2026-05-21  
...
| Criblage sanctions / PPE | Obligation légale — R. 2016/847, UE 2023/1113 | Art. 6(1)(c) |
...
| Non-conformité TRACFIN (déclaration de soupçon) | Faible | Élevée | FAIBLE | Flux TRACFIN via AMF/ACPR ; rôle COMPLIANCE_OFFICER |
