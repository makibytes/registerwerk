...
| [Canton / Daml](canton.md) | DAML_BOND_*; CANTON_TOKEN reserved | Ledger API v2 Java client | Canton Network, devnet | Custom bond lifecycle profile-verified; live/payment conformance required |
