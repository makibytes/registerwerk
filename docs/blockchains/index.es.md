...
| [Canton / Daml](canton.md) | DAML_BOND_*; CANTON_TOKEN reservado | Cliente Java de Ledger API v2 | Canton Network, devnet | Ciclo de bonos verificado por perfil; se requiere conformidad en vivo y de pagos |
