...
| Retransmisor confidencial | Lint superado; 33/33 pruebas superadas | La auditoría de dependencias reportó 21 hallazgos de gravedad alta; el lockfile estaba ausente antes de la instalación de referencia |
| Subgrafo EVM | 16 ABI de contrato / 71 handlers, 25 entidades de estado de proyección, renderizador de instancias múltiples, codegen, todas las compilaciones de mapeo y las puertas de despliegue etiquetadas pasan | La reorganización/finalidad, la repetición/conciliación en vivo, y la identidad de bytecode por RPC, siguen pendientes; la auditoría de dependencias todavía reporta 45 hallazgos, incluidos dos críticos |
| Apps Angular de operador/inversor | Los comandos de CI fallan | Ambos flujos de trabajo invocan un target de lint inexistente; Karma espera `karma-jasmine`, que falta; no se encontraron archivos de test |
| Documentación en Docusaurus | Las compilaciones de producción en inglés y alemán pasan tras correcciones de veracidad/compilación | La auditoría de dependencias todavía reportó 37 hallazgos, incluidos dos críticos |
