...
const sidebars: SidebarsConfig = {
  operatorSidebar: [
    ...
    {type: 'category', label: 'Configuration', items: ['configuration/environment', 'configuration/chains', 'configuration/indexers', 'configuration/identity-provider', 'configuration/email', 'configuration/regulatory-compliance']},
